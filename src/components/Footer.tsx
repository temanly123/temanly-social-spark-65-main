        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Connect with amazing people for unforgettable experiences. From casual conversations to exciting adventures, find your perfect companion.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/rent" className="text-gray-300 hover:text-white transition-colors">Rent</Link></li>
