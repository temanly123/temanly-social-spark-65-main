...
-- Create RLS policies on storage.buckets table if they don't exist
CREATE POLICY IF NOT EXISTS "allow_authenticated_bucket_access"
ON storage.buckets FOR ALL TO authenticated
USING (true)
WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "allow_service_role_bucket_access"
